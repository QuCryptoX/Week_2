...
function bell_test_calculations(rho_AB, theta_0 = 0, theta_1 = 45, gamma_0 = 22.5, gamma_1 = 77.5)
    ...
    p00_00 = trace(AB_00_00*rho_AB)
    p00_01 = trace(AB_01_00*rho_AB)
    p00_10 = trace(AB_10_00*rho_AB)
    p00_11 = trace(AB_11_00*rho_AB)

    p01_00 = trace(AB_00_01*rho_AB)
    p01_01 = trace(AB_01_01*rho_AB)
    p01_10 = trace(AB_10_01*rho_AB)
    p01_11 = trace(AB_11_01*rho_AB)

    p10_00 = trace(AB_00_10*rho_AB)
    p10_01 = trace(AB_01_10*rho_AB)
    p10_10 = trace(AB_10_10*rho_AB)
    p10_11 = trace(AB_11_10*rho_AB)

    p11_00 = trace(AB_00_11*rho_AB)
    p11_01 = trace(AB_01_11*rho_AB)
    p11_10 = trace(AB_10_11*rho_AB)
    p11_11 = trace(AB_11_11*rho_AB)
